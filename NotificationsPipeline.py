...
class NotificationsPipeline(object):
    ...
    def on_enter(message, pipeline_step_list = pipeline_step_list):
        ...
        if message.current_step == pipeline_step_list[0]:
            ...
            message.history[0].enter_timestamp = datetime.utcnow() # Assign the entry timestamp
            ...
            message.history[0].exit_timestamp = datetime.utcnow()
            # exit()
        ...
        # Identify last time
            ...
            message.history[pipeline_step_pointer].enter_timestamp = datetime.utcnow()
            ...
            message.history[pipeline_step_pointer-1].exit_timestamp = datetime.utcnow()
            NotificationsPipeline.on_enter(message)
